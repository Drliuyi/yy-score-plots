...
method_inputs() {
  ...
  case "$method" in
    ...
    yu-strict)
      ...
      echo "  SOURCE_SUPPLEMENT_WORKBOOK=${YU_STRICT_SUPPLEMENT_WORKBOOK}"
      echo "  SOURCE_SUPPLEMENT_METHODS=${YU_STRICT_SUPPLEMENT_METHODS}"
      echo "  SOURCE_OLINK_DATES=${YU_STRICT_OLINK_DATES}"
